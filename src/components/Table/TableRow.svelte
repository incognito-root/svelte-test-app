		...
		>
			<div class="wrapper">
				<div
					...
					class="swipe-container swipe-column flex gap-1"
				>
				...
				<div id="button-container" class="button-container">
					<button class="bg-blue-700 px-6 text-white" on:click={() => alert('edit')}>Edit</button>
					<button class="bg-red-700 px-6 text-white" on:click={() => alert('delete')}>Delete</button
					>
				</div>
			</div>
		</td>
